...
BEGIN {
    ...
    require '/home/crash/nostr/externals/openssl-3.3.2/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/crash/nostr/externals/openssl-3.3.2/test/fips-and-base.cnf';
    shift;
